<header>
    <div class="logo">
        <a href="trangchu.php"><img src="http://localhost/webivymoda/public/img/images/logo.webp"></a>
    </div>
    <div class="menu">
        <li><a href="">NỮ</a>
            <ul class="Sub-Menu">
                <li><a href="cartegory.html">Hàng nữ mới về</a></li>
    ...
    <div class="others">
        ...
        <li>
            ...
            <a class="fas fa-sign-out-alt" href="http://localhost/webivymoda/nguoidung/page/logout.php"></a>
            <?php else : ?>
            <a class="fa fa-user" href="http://localhost/webivymoda/nguoidung/page/login.php"></a>
            <?php endif ?>
        </li>
