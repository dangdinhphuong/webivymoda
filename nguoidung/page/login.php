...
<head>
    ...
    <!-- Font awesome -->
    <link href="http://localhost/webivymoda/public/css/font-awesome.css" rel="stylesheet">
    <!-- Bootstrap -->
    <link href="http://localhost/webivymoda/public/css/bootstrap.css" rel="stylesheet">
    <!-- Theme color -->
    <link id="switcher" href="http://localhost/webivymoda/public/css/default-theme.css" rel="stylesheet">
    <!-- Top Slider CSS -->
    <link href="http://localhost/webivymoda/public/css/sequence-theme.modern-slide-in.css" rel="stylesheet" media="all">

    <!-- Main style sheet -->
    <link href="http://localhost/webivymoda/public/css/style_login.css" rel="stylesheet">
                                ...
                                <div class="aa-myaccount-register">
                                    ...
                                    <form method="POST" action="" class="aa-login-form">
                                        ...
                                        <input type="text" name="username"
                                            ...
                                            <label style="color:red"><?= (isset($errors['username']) ? $errors['username'] : '') ?></label><br>
                                        <label for="">Nhập email<span>*</span></label>
                                        <input type="text" name="email" value="<?php echo $_POST['email'] ?? '' ?>"
                                            placeholder="Username or email">
                                            <label style="color:red"><?= (isset($errors['email']) ? $errors['email'] : '') ?></label> <br>
                                        <label for="">Nhập mật khẩu<span>*</span></label>
                                        <input type="password" name="password" placeholder="Password">
                                        <label style="color:red"><?= (isset($errors['password']) ? $errors['password'] : '') ?></label><br>
                                        <label for="">Nhập lại mật khẩu<span>*</span></label>
                                        <input type="password" name="repassword" placeholder="Password">
                                        <label style="color:red"><?= (isset($errors['repassword']) ? $errors['repassword'] : '') ?></label><br>
