                ...
                <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="product_detail.php?id=<?= $product["product_id"] ?>"><img
                                                title="<?= $product["Tensp"] ?>"
                                                src="http://localhost/webivymoda/admin/images/products/<?= $product["Anh_sp"] ?>" /></a>
                                    </td>
                                    <td class="hidden-xs">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="col-md-12">
                            ...
                            <p class="text-center">
                                <a href="trangchu.php" id="but-checkout-continue">Tiếp tục mua
                                    sắm</a>
                                <a href="" id="but-checkout-step1">Thanh
                                    toán</a>
                            </p>
